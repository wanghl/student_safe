...
public class SettingWindow extends javax.swing.JFrame {
		...
		try {
			...
			setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
			{
				...
				jPanel1.setLayout(jPanel1Layout);
				{
					...
					jPanel2.setBorder(BorderFactory.createTitledBorder("´®¿ÚÉèÖÃ"));
					{
						jLabel1 = new JLabel();
						jLabel1.setText("\u6ce2\u7279\u7387");
					}
					{
						// ×Ô¶¯»ñÈ¡µ±Ç°»úÆ÷µÄCOM¿ÚÁÐ±í
				...
				}
				{
					...
					jPanel3.setBorder(BorderFactory.createTitledBorder("ÔÓÏî"));
					{
						jLabel3 = new JLabel();
						jLabel3
								.setText("\u6536\u77ed\u4fe1\u56de\u6267\u95f4\u9694");
	...
	private void submitButtonPerformeAction(ActionEvent evt) {
		...
		try {
			...
			log.error("±£´æÉèÖÃÊ§°Ü:" + e.getLocalizedMessage());
			MessageWindow.show("±£´æÉèÖÃÊ§°Ü:" + e.getLocalizedMessage(), null);
			this.dispose();
		}
	}
