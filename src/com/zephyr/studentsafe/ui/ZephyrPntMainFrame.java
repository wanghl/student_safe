						...
						toolsBar.setEnabled(false);
						{
							...
							jPanel1.setPreferredSize(new java.awt.Dimension(125, 28));
							{
								...
								jPanel2.setPreferredSize(new java.awt.Dimension(796, 44));
								{
									...
									startButton.setIcon(new ImageIcon(getClass().getClassLoader().getResource("com/zephyr/studentsafe/icons/start.png")));
								...
								}
								{
									...
									settingButton.addActionListener(new ActionListener() {
										...
										public void actionPerformed(ActionEvent evt) {
											try {
												action.settingButtonPerformeAction(evt, settingButton) ;
											} catch (StudentSafeException e) {
												// TODO Auto-generated catch block
												e.printStackTrace();
											}
								...
								}
								{
									...
									jButton2.setIcon(new ImageIcon(getClass().getClassLoader().getResource("com/zephyr/studentsafe/icons/BWS_006.png")));
									...
									jButton2.addActionListener(new ActionListener() {
										public void actionPerformed(ActionEvent evt) {
											...
											for (; searchIndex < rowCount; searchIndex++) {
												...
												if (searchIndex == rfidInfoTable.getSelectionModel().getAnchorSelectionIndex()){
													continue ;
												}
												...
												if (cid.equals(cardFindInput.getText().trim())) {
													rfidInfoTable.getSelectionModel()
															.setSelectionInterval(searchIndex, searchIndex);
													reg = rfidInfoTable.getCellRect(searchIndex, 1, true);
											...
											//遍历整个表格后，searchIndex= RowCount().归零
									...
									jPanel3.setMaximumSize(new java.awt.Dimension(200, 38));
									{
										...
										normalRadio.addActionListener(new ActionListener() {
											public void actionPerformed(ActionEvent evt) {
												...
												//TODO add your code for normalRadio.actionPerformed
											}
										});
									}
									{
								...
								jPanel2Layout.setHorizontalGroup(jPanel2Layout.createSequentialGroup()
									.addComponent(startButton, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(jSeparator3, GroupLayout.PREFERRED_SIZE, 1, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(settingButton, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(jSeparator4, GroupLayout.PREFERRED_SIZE, 3, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(countButton, GroupLayout.PREFERRED_SIZE, 51, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(jSeparator5, GroupLayout.PREFERRED_SIZE, 3, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									...
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(jPanel3, GroupLayout.PREFERRED_SIZE, 201, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(jSeparator6, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(cardFindInput, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
								...
								jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup()
									.addGroup(GroupLayout.Alignment.LEADING, jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
									    .addComponent(startButton, GroupLayout.Alignment.BASELINE, 0, 38, Short.MAX_VALUE)
									    .addComponent(jSeparator3, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
									    .addComponent(settingButton, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
									    .addComponent(jSeparator4, GroupLayout.Alignment.BASELINE, 0, 38, Short.MAX_VALUE)
									    .addComponent(countButton, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
									    .addComponent(jSeparator5, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
									    .addComponent(jButton3, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
									    .addComponent(jSeparator7, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
									    .addComponent(jSeparator6, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
									    .addComponent(jButton2, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE))
									.addComponent(jPanel3, GroupLayout.Alignment.LEADING, 0, 38, Short.MAX_VALUE)
									.addGroup(GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
									    .addGap(7)
									    .addComponent(cardFindInput, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE)
									    .addGap(0, 8, Short.MAX_VALUE)));
								jPanel2Layout.linkSize(SwingConstants.VERTICAL, new Component[] {jSeparator3, settingButton, jSeparator4, countButton});
							}
						}
					}
				}
							...
							jScrollPane1.setPreferredSize(new java.awt.Dimension(816, 338));
							{
								TableModel rfidInfoTableModel = 
									new DefaultTableModel(
											null,
											new String[] { "序号", "卡号","时间", "首次经过区域", "最终经过区域", "被扫描次数", "结果" });
						...
						}
						{
							...
							jScrollPane3.setFont(new java.awt.Font("楷体",0,15));
							{
								TableModel dataMonitTableModel = 
									new DefaultTableModel(
											new String[][] {  { "入校人数", "0" }, { "出校人数", "0" }, { "未离开区域人数", "0" }, { "共计", "0" },{ "待处理队列长度", "0" } },
											new String[] { "数据项", "值" });
							...
							//	dataMonitTable.setModel(dataMonitTableModel);
								...
								dataMonitTable.getTableHeader().getColumnModel().getColumn(0).setPreferredWidth(150);
								dataMonitTable.getTableHeader().getColumnModel().getColumn(1).setPreferredWidth(850);
								//居中显示
								DefaultTableCellRenderer  renderer = (DefaultTableCellRenderer) dataMonitTable.getTableHeader().getDefaultRenderer();
								renderer.setHorizontalAlignment(renderer.CENTER);
								//行高
								dataMonitTable.setRowHeight(20);
								dataMonitTable.setPreferredSize(new java.awt.Dimension(806, 108));
								//好吧。。。。设置背景颜色，显的牛逼些。。。。
								dataMonitTable.setDefaultRenderer(Object.class, new RowColorRenderer()) ;
					...
					}
					{
						...
						clearRfidTable.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent evt) {
								...
								//TODO add your code for clearRfidTable.actionPerformed
							}
						});
					}
					{
